...
CREATE INDEX "calibrations_has_calibration_stacks.fk_calibrations_has_calibration_stacks_calibrations1_idx" ON "calibrations_has_calibration_stacks" ("calibrations_id","calibrations_chemicals_id","calibrations_measuring_conditions_gain_factor","calibrations_measuring_conditions_exposition");
 ...
 DROP TRIGGER IF EXISTS UpdateIdIn_conditions_has_sample_tasks_BEFORE_INSERT;
 CREATE TRIGGER IF NOT EXISTS UpdateIdIn_conditions_has_sample_tasks_BEFORE_INSERT 
 BEFORE INSERT ON "conditions_has_sample_tasks" 
 FOR EACH ROW 
 BEGIN 
 INSERT INTO "conditions_has_sample_tasks" ("id", 
 "measuring_conditions_gain_factor",
 "measuring_conditions_exposition",
 "sample_tasks_id") 
 VALUES((SELECT MAX("id") FROM conditions_has_sample_tasks) + 1, 
 NEW.measuring_conditions_gain_factor,
 NEW.measuring_conditions_exposition,
 NEW.sample_tasks_id); 
 END;
