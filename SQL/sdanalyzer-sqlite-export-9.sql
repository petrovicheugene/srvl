...
CREATE INDEX "sdAnalyzer"."measured_chemicals.fk_measured_chemicals_measured_samples1_idx" ON "measured_chemicals" ("measured_samples_id");
...
CREATE INDEX "sdAnalyzer"."measured_spectra.fk_measured_spectra_measuring_conditions1_idx" ON "measured_spectra" ("measuring_conditions_id");
COMMIT;
