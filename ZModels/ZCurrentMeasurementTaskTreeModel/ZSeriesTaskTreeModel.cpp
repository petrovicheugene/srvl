...
void ZSeriesTaskTreeModel::zh_onNewTaskAction()
{
    ...
    int sampleTaskQuantity = dialog.zp_sampleTaskQuantity();
    QString defaultSampleName = dialog.zp_defaultSampleName();
...
//===========================================================
void ZSeriesTaskTreeModel::zh_checkTaskName(const QString& taskName, bool& res)
{
    if(taskName.isEmpty())
    {
